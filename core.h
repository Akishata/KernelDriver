...
namespace core
{
	NTSTATUS write_memory(int pid, void* addr, void* value, size_t size);
	NTSTATUS read_memory(int pid, void* addr, void* value, size_t size);

	NTSTATUS AllocMemory(int pid, void* addr, size_t size, DWORD protect);
	NTSTATUS FreeMemory(int pid, void* addr);
}